...
async def send_start_image(message):
    try:
        ...
        await message.reply_photo(
            ...
            caption="ɪᴀᴍ ʏᴏᴜʀs  🤖𝐓𝐄𝐗𝐓 𝐓𝐄𝐑𝐌𝐈𝐍𝐈𝐓𝐎𝐑 ᴀ  ʙᴏᴛ ᴡɪᴛʜ ᴍᴜʟᴛɪᴘʟᴇ ғᴜɴᴄᴛɪᴏɴ . 𝐈 ᴡɪʟʟ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴋᴇᴇᴘ ʏᴏᴜʀ ɢʀᴏᴜᴘ sᴀғᴇ ғʀᴏᴍ ©️ ᴍᴀᴛᴇʀɪᴀʟ [ 𝐀ᴅᴅ ᴍᴇ &𝐃ᴇʟᴇᴛᴇ ᴍᴀssᴀɢᴇ ]  𝐈 ᴡɪʟʟ ᴀssɪsᴛ ᴜ  ᴛᴏ👇 200 ᴡᴏʀᴅs ʟɪᴍɪᴛ  𝐈 ᴄᴀɴ ᴅᴇʟᴇᴛᴇ ✯ѕтι¢кєя & gιf  αfтєя 30 мιи 🪄 ✯ є∂ιт тєχт/мє∂ια  🪄 ✯ вσтѕ мαѕѕαgє🪄 ✯ ¢σρуяιgнт ¢σитєит 🪄{}",
